...
Actual text content size: 98.69 KB
Total lines of content: 2,393
...
└── Parthdsaiml-NullP
    ...
    │   ├── RemovingNullValues.md
    │   ├── Tests
    │   │   └── Normality Test..md
    │   └── Detecting Outliers.md
    ├── MainCode.py
    ├── FormulasLInearRegression.md
    └── Normalization.md


Detailed Content:
==================================================
File: ../tmp/Parthdsaiml-NullP/OverView.txt
==================================================
Major Tasks to be done in this Project
1. Finding Null Values
2. Identifying Outliers
3. Identifying Irrelevant Columns
4. Filtering Out Null Values, Outliers, and Irrelevant Columns
5. Visualizing the Changes Before and After Using Graphs
6. Automating the Filtering and Detection Process Using Basic Methods and ML Models for Complex Data
7. Automating the Detection of Data Complexity
8. Creating a Method to Provide Suggestions
9. Automating the Entire Process and Outputting Clean Data Ready for ML Training or Insight Generation
10. Providing an Overview of the Process and Outcomes


==================================================
File: ../tmp/Parthdsaiml-NullP/Inconsistentdata.md
==================================================
...
==================================================
File: ../tmp/Parthdsaiml-NullP/Tasks.md
==================================================
...
==================================================
File: ../tmp/Parthdsaiml-NullP/Handling Values/Handling Outliers.md
==================================================
...
==================================================
File: ../tmp/Parthdsaiml-NullP/Handling Values/RemovingNullValues.md
==================================================
...
==================================================
File: ../tmp/Parthdsaiml-NullP/Handling Values/Tests/Normality Test..md
==================================================
...
==================================================
File: ../tmp/Parthdsaiml-NullP/Handling Values/Detecting Outliers.md
==================================================
...
==================================================
File: ../tmp/Parthdsaiml-NullP/MainCode.py
==================================================
import pandas as pd
import numpy as np
...
==================================================
File: ../tmp/Parthdsaiml-NullP/FormulasLInearRegression.md
==================================================
...
==================================================
File: ../tmp/Parthdsaiml-NullP/Normalization.md
==================================================
--------------------------------------------------------------
                      Min-Max Scaling
--------------------------------------------------------------
